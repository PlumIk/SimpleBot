...
class AddNoteScene(NoteSceneExample):
    ...
    def start_work(self, params: SceneParams) -> None:
        ...
        self.notes.AddNote(params.USER_MESSAGE)
        nextScene = ShowNotesScene()
        nextScene.SetNote( self.notes)
        nextScene.start_work(params)
